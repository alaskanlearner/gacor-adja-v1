...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6442960237:AAE2--Y2_uF0ye2dYUlXiteDCmhIlFK8oU8")
...
# ID Channel Database
CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1001826123739"))

# Database
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://uklyayet:NMrt0oRfhlAuisNLL_2iDAr5LrcZvQte@topsy.db.elephantsql.com/uklyayet")
